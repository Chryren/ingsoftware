...
<head>
    ...
    <link href="Stylecliente.css" rel="stylesheet">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="list-group">
                    ...
                    <a href="reservahistadmin.php" class="list-group-item list-group-item-action list-group-item-warning">Historial de pedidos</a>
                </div>
            </div>
        </div>
    </div>
